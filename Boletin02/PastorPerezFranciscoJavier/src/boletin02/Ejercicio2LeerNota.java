...
public class Ejercicio2LeerNota {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		
//NOTA IMPORTANTE: en este intente hacerlo sin las expresiones regulares, es identico
//al otro ejercicio 2 excepto el primer apartado. ya que en el otro no consegui una expresion
//para lode poner el . despues de la @		
